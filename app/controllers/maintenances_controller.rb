class MaintenancesController < ApplicationController
  ...
  private
    ...
    def set_maintenance
      @maintenance = current_power.maintenances.find_by(:id => params[:id])
      redirect_to maintenances_url unless @maintenance
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def maintenance_params
      params.require(:maintenance).permit(:item, :page, :pdf, :inspectMiles, :inspectMonths, :replaceMiles, :replaceMonths)
    end
end
